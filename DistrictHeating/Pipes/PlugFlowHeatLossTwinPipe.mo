...
equation
  ...
  connect(senTem2.T, twinExponentialDecay.T2) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(senTem1.port_b, idealHeater1.port_a)
    annotation (Line(points={{-4,60},{24,60},{52,60}}, color={0,127,255}));
  connect(idealHeater1.port_b, port_b1)
    annotation (Line(points={{72,60},{100,60}}, color={0,127,255}));
  connect(twinExponentialDecay.T1Out, idealHeater1.TSet) annotation (Line(
        points={{33,14},{40,14},{40,54},{50,54}}, color={0,0,127}));
  connect(senTem2.port_b, idealHeater2.port_a) annotation (Line(points={{-10,-60},
          {-25,-60},{-40,-60}}, color={0,127,255}));
  connect(idealHeater2.port_b, port_b2)
    annotation (Line(points={{-60,-60},{-100,-60}}, color={0,127,255}));
  connect(twinExponentialDecay.T2Out, idealHeater2.TSet) annotation (Line(
        points={{33,6},{40,6},{40,-40},{-20,-40},{-20,-54},{-38,-54}}, color={0,
          0,127}));
